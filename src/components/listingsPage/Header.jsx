...
Get free delivery on orders over $100, T&C Applied
            ...
            <div className="flex h-16 items-center">
              ...
              <div className="ml-auto flex items-center">
                ...
                <div className="flex lg:ml-6">
                  <a onClick={toggleSearchBar} className="p-2 text-gray-400 hover:text-gray-500">
        ...
        >
          {(ref) => (
            <div
            ref={ref}
            className={`fixed inset-0 w-full h-screen bg-white z-50 flex flex-col items-center justify-center ${
              searchOpen ? 'opacity-100' : 'opacity-0 pointer-events-none'
            }`}
          >
              <button
                onClick={toggleSearchBar} // Close the search bar when clicked
                className="absolute top-4 right-4 text-gray-400 hover:text-gray-500"
              >
                <XMarkIcon className="h-6 w-6" aria-hidden="true" />
              </button>
              {/* Your search input field and search logic here */}
              <input
                type="text"
                placeholder="Search..."
                className="px-4 py-2 w-half border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
              />
            </div>
          )}
        </Transition>
