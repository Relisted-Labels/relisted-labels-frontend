...
const ImageCardSlider = () => {
  ...
  const images = [
    'https://via.placeholder.com/200x150/FF5733/FFFFFF?text=Image1',
    'https://via.placeholder.com/200x150/33FF57/FFFFFF?text=Image2',
    'https://via.placeholder.com/200x150/5733FF/FFFFFF?text=Image3',
    'https://via.placeholder.com/200x150/FFFF33/000000?text=Image4',
    'https://via.placeholder.com/200x150/FFFF33/000000?text=Image4',
    'https://via.placeholder.com/200x150/FFFF33/000000?text=Image4',
  ];
  const nextSlide = () => {
    setCurrentIndex((prevIndex) =>
      Math.min(prevIndex + 4, images.length - 4)
    );
  };
